...
function CardModal2({ modalOpen, closeModal }) {
  return (
    modalOpen?

    <ModalTemplate coverExist={true} exitByOuterClick={true} closeModal={closeModal}>
      <Card $width='300px' $height='200px'>
        <div>닫기 버튼 1개가 있고, <br /> 외부 영역을 누르면 모달이 닫혀요.</div>
        <RowDirectionContainer $top='12px' $right='12px'>
